<!DOCTYPE html>
<!--
- Page de modification de Payement
- 
- @author Alexis BATTAGLI
- @version 0.1
- 
- Permet d'afficher un formulaire pour modifier un Payement
...
<html lang="fr">
    <head>
        ...
        <title>Modification de Moyen de Payement</title>
        ...
        <div class="container">
            ...
            if ($validId != null)
            {
                ...
                if (is_int($validId))
                {
                    ...
                    $payement = PayementDAL::findById($validId);
                    if (is_null($payement))
                    {
                        echo "[DEBUG]Aucun Payemenrt trouver avec cette ID...</br>";
                    }
                    else
                    {
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form action=<?php $_SERVER['DOCUMENT_ROOT'] ?>"/controller/page/mod_payement.php" method="POST">
                                    <legend>Formulaire de modification d'un Payement</legend>

                                    <!-- Nom du Moyen-->
                                    <div class="col-lg-2">
                                        <label for="moyen" class="control-label">Moyen : </label>
                                        <input type="text" maxlength="30" name="moyen" class="form-control" id="moyen" value="<?php echo $payement->getMoyen(); ?>">
                                    </div>

                                    <!-- Bouton de Validation-->
                                    <div class="col-lg-2">
                                        </br>
                                        <input type="submit" value="Modifier ce Payement" class="btn btn-success btn-block"/>
                                    </div>

                                    <!-- ID du Lieu Caché et modification désactiver-->
                                    <div class="col-lg-2" hidden>
                                        <label for="id" class="control-label">Id : </label>
                                        <input type="text" name="id" class="form-control" id="id" value="<?php echo $payement->getId(); ?>">
                                    </div>
                                </form>
